...
class GroupHelper:
    ...
    def change_field_valueee(self, field_name, text):
        wd = self.app.wd
        if text is not None:
    ...
    def fill_group_form(self, group):
        wd = self.app.wd
        self.change_field_valueee("group_name", group.name)
        self.change_field_valueee("group_header", group.header)
        self.change_field_valueee("group_footer", group.footer)
